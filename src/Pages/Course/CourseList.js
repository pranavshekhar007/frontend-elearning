...
function CourseList() {
  ...
  const handleGetCourses = async () => {
    ...
    try {
      const res = await getCourseServ(payload);
  ...
  const handleAddCourse = async () => {
    ...
    try {
      const res = await addCourseServ(courseFormData);
  ...
  const handleUpdateCourse = async () => {
    ...
    try {
      const response = await updateCourseServ(editId, courseFormData);
  ...
  const handleDeleteCourse = async (id) => {
    ...
    try {
      const res = await deleteCourseServ(id);
      if (res?.data?.statusCode === 200) {
  ...
  return (
    <div className="bodyContainer">
      <Sidebar selectedMenu="Course" selectedItem="Course List" />
        ...
        <div className="p-lg-4 p-md-3 p-2">
          ...
          <div className="row m-0 p-0 d-flex align-items-center my-4 topActionForm">
            <div className="col-lg-2 mb-2 col-md-12 col-12">
              <h3 className="mb-0 text-bold text-secondary">Courses</h3>
            </div>
                ...
                <table className="table">
                  <thead>
                    <tr style={{ background: "#F3F3F3", color: "#000" }}>
                      ...
                      <th className="text-center py-3">Course Name</th>
